...
public class CatProgressBarUi extends BasicProgressBarUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        ...
        return new CatProgressBarUi();
    }

    @Override
    public Dimension getPreferredSize(JComponent c) {
        return new Dimension(super.getPreferredSize(c).width, JBUI.scale(40));
   }
...
//        g.setPaint(baseRainbowPaint);
        ...
        final float R = JBUI.pixScale(18f);
        final float R2 = JBUI.pixScale(19f);
...
//                new Color[]{JBColor.RED, JBColor.ORANGE, JBColor.YELLOW, JBColor.GREEN, JBColor.cyan, JBColor.blue, VIOLET}));
        ...
        CAT_GIT.paintIcon(progressBar, g2, amountFull - JBUI.scale(10), 0);
